...
def generateExternalFunction_custom(
        baseDir, dataDir,  
    ...
    # %% Process settings.
    pathCWD = os.getcwd()
    osDir = os.path.join(pathCWD, dataDir, 'OpenSimData')
    pathModelFolder = os.path.join(osDir, 'Model')
    suffix_MA = '_adjusted'
    if contact_side != 'all':
...
def buildExternalFunction_custom(filename, pathDCAD, CPP_DIR, nInputs,
